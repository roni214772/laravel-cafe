...
<div class="card">
  ...
  <div class="footer">
    <a href="<?php echo e(route('password.request')); ?>">Şifremi unuttum</a>
    &nbsp;·&nbsp;
    Hesabın yok mu? <a href="<?php echo e(route('register')); ?>">Kayıt ol</a>
  </div>
  <div style="text-align:center;margin-top:14px;">
    <a href="<?php echo e(route('admin.login')); ?>" style="font-size:.68rem;color:#3a3a3a;text-decoration:none;letter-spacing:.3px">
      ⚙ Yönetici Girişi
    </a>
  </div>
</div>
...
<?php /**PATH C:\Users\brusk\OneDrive\Masaüstü\eto\laravel-cafe\resources\views/auth/login.blade.php ENDPATH**/ ?>