...
<title>Şifremi Unuttum — Kafe POS</title>
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  h2{font-size:1.1rem;font-weight:700;margin-bottom:10px;color:var(--text);text-align:center}
  .desc{font-size:.78rem;color:var(--muted);text-align:center;margin-bottom:24px;line-height:1.6}
  ...
  .success{background:#0a2a1a;border:1px solid #1a5a3a;color:#6ee7b7;border-radius:8px;
           padding:10px 14px;font-size:.78rem;margin-bottom:16px;line-height:1.5}
...
<div class="card">
  <div class="logo">
    ...
    <div>
      ...
      <div class="logo-sub">Şifre Sıfırlama</div>
    </div>
  </div>

  <h2>Şifremi Unuttum</h2>
  <p class="desc">E-posta adresinizi girin, şifre sıfırlama bağlantısı gönderelim.</p>
  ...
  <form method="POST" action="<?php echo e(route('password.email')); ?>">
    ...
    <div class="fg">
      <label>E-posta</label>
      <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="kafe@ornek.com" required autofocus>
    </div>
    <button type="submit" class="btn-submit">Sıfırlama Bağlantısı Gönder →</button>
  </form>

  <div class="footer">
    <a href="<?php echo e(route('login')); ?>">← Giriş sayfasına dön</a>
  </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\brusk\OneDrive\Masaüstü\eto\laravel-cafe\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>