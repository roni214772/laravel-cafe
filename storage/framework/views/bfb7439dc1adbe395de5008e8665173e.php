...
<div class="wrap">
  ...
  <div class="card">
    ...
    <div class="footer">
      Normal kullanıcı mısınız? <a href="<?php echo e(route('login')); ?>">Standart giriş</a>
    </div>
  </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\brusk\OneDrive\Masaüstü\eto\laravel-cafe\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>