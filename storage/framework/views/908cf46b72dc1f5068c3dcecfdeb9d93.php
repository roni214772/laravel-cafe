...
<div class="wrap">
  ...
  <div class="mini-nav">
    <a href="<?php echo e(route('subscription.select')); ?>" class="back-btn"> Geri</a>
    <div class="mini-spacer"></div>
    <span class="mini-brand"> Kafe POS</span>
  </div>

  <div class="plan-pill">
    <span class="plan-pill-name"><?php echo e($label); ?></span>
    <span class="plan-pill-price">
      ₺<?php echo e(number_format((float)$price, 0, ',', '.')); ?>

      <small> / <?php echo e($plan === 'yearly' ? 'yıl' : 'ay'); ?></small>
    </span>
  </div>
  ...
  <div class="card-wrap">
    ...
    <div class="c-content">
      ...
      <div class="c-top">
        <div class="c-bank">
          <div class="c-bank-icon">
            ...
            <span class="c-bank-name"><?php echo e($bankName); ?></span>
          </div>
      ...
      <div class="c-number" id="ibanVal"><?php echo e($iban); ?></div>

      
      <div class="c-bottom">
        <div class="c-field">
          <div class="c-field-lbl">Hesap Sahibi</div>
          <div class="c-field-val"><?php echo e($accountHolder); ?></div>
        </div>
  ...
  <div class="info-row">
    <div>
      ...
      <div class="info-val amount">₺<?php echo e(number_format((float)$price, 2, ',', '.')); ?></div>
    </div>
  </div>
  ...
  <div class="info-row">
    <div style="min-width:0">
      ...
      <div class="info-val"><?php echo e($iban); ?></div>
    </div>
  ...
  <div class="confirm-box">
    ...
    <form method="POST" action="<?php echo e(route('payment.confirm-transfer')); ?>">
      <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\brusk\OneDrive\Masaüstü\eto\laravel-cafe\resources\views/payment/checkout.blade.php ENDPATH**/ ?>