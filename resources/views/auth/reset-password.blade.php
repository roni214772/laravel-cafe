...
<title>Yeni Şifre — Kafe POS</title>
...
<div class="card">
  <div class="logo">
    ...
    <div>
      ...
      <div class="logo-sub">Yeni Şifre Belirle</div>
    </div>
  </div>
  ...
  <form method="POST" action="{{ route('password.update') }}">
    ...
    <div class="fg">
      <label>E-posta</label>
      <input type="email" name="email" value="{{ old('email', $email ?? '') }}" placeholder="kafe@ornek.com" required>
    </div>
    <div class="fg">
