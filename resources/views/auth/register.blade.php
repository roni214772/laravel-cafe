...
<div class="card">
  ...
  <form method="POST" action="{{ route('register') }}">
    ...
    <div class="fg">
      ...
      <input type="text" name="name" value="{{ old('name') }}" placeholder="Örn: Café Luna" required autofocus>
    </div>
    <div class="fg">
      <label>E-posta</label>
      <input type="email" name="email" value="{{ old('email') }}" placeholder="kafe@ornek.com" required>
    </div>
    <div class="fg">
      <label>Şifre</label>
